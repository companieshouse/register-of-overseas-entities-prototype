module.exports = function (router) {
  router.get( '/register/managing-officer-corporate', function ( req, res ) {

  	res.render( 'register/managing-officer-corporate', {
    });
  })
  router.post('/register/managing-officer-corporate', function (req, res) {
