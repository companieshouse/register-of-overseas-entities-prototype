module.exports = function (router) {
  router.get( '/register/beneficial-owner-other', function ( req, res ) {

  	res.render( 'register/beneficial-owner-other', {
    });
  })
  router.post('/register/beneficial-owner-other', function (req, res) {
